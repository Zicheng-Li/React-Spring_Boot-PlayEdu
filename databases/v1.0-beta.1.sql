...
use playedu;
UPDATE admin_roles SET name = 'Super Admin Role' WHERE slug = 'super-role';
ALTER TABLE admin_users MODIFY name VARCHAR(64);

UPDATE admin_users SET name = 'Super Administrator' WHERE email = 'admin@playedu.xyz';
